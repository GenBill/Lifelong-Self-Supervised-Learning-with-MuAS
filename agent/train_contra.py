from .mydataset import ContrastiveDataset
...
def contratrain(model, fc_layer, dataloaders, criterion, optimizer, scheduler, device, checkpoint_path, file, saveinterval=1, num_epochs=20):
    since = time.time()
