...
class omega_update(optim.SGD):
    ...
    def __init__(self, params, lr = 0.001, momentum = 0, dampening = 0, weight_decay = 0, nesterov = False, miu = 1.0):
        ...
        for group in self.param_groups:
            ...
            for p in group['params']:
                ...
                if p in reg_params:
                    ...
                    omega = self.miu * omega + step_size*(grad_data_copy - batch_size*(omega))
            ...
            for p in group['params']:
                ...
                if p in reg_params:
                    ...
                    if not finality:
                        ...
                        #Incremental update for the omega  
                        omega = self.miu * omega + step_size*(temp_grad - batch_size*(omega))
