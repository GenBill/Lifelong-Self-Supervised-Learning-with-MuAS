...
parser.add_argument('--weight_net', type=float, default=1e-2, help="weight decay")
parser.add_argument('--weight_fc', type=float, default=1e-2, help="weight decay")
...
milestones = [5, 10, 20, 40, 80, 120, 160, 200, 300, 400, 800]
milegamma = 0.8
