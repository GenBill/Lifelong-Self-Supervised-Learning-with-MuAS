...
# ResNet-18 装载
this_Epoch = 0
checkpoint_path = '/home/zhangxuanming/eLich/Saved_models/valid_FSLL_25'      # 'E:/Laplace/Dataset/Kaggle265/valid'
...
optimizer = optim.Adam(
    [
        {'params': (p for name, p in net.named_parameters() if 'weight' in name), 'lr': 1e-4, 'momentum': 0.6, 'weight_decay': 1e-8},
...
shadow_net = Get_shadow_net(net, 0.25)
