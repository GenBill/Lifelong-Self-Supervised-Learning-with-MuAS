...
# optimizer_sp_0 = local_sgd(model.parameters(), reg_lambda, lr)
# optimizer_sp_0.step(model.parameters())

# optimizer_sp_1 = local_sgd(model.features.parameters(), reg_lambda, lr)
# optimizer_sp_1.step(model.features.parameters())
